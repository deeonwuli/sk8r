            ...
            <header className="px-4 relative bg-gradient-to-l from-purple via-blush to-purple h-5/6 flex flex-col justify-between items-center text-xl text-snow tracking-widest">
                <div className="mt-60 lg:mt-28 flex flex-row items-center">
                    ...
                    <p className="text-stroke-2 lg:text-stroke-4 text-stroke-black text-5xl lg:text-9xl">Sk8r</p>
                        <Link to="/play">
                            <button className="flex flex-row items-center border-2 w-min px-2 lg:px-5 py-2 rounded-3xl bg-blue border-blue shadow-xl hover:bg-green hover:text-black hover:-translate-y-3">
                    ...
                    <div className="flex flex-col justify-between items-center -ml-28 lg:-ml-48 z-30">
                        ...
                        <button onClick={handleClickOpen} className="flex flex-row items-center border-2 w-min px-2 lg:px-5 py-2 rounded-3xl bg-blue border-blue shadow-xl hover:bg-green hover:text-black hover:-translate-y-3">
                            settings
                        ...
                        >
                            ...
                            <DialogContent className="bg-green" style={{ fontFamily: 'Skater-girl' }}>
                                <DialogContentText id="settings modal">
                                    <label className="flex flex-row">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-5" fill="none" viewBox="0 0 24 24" stroke="#000000">
